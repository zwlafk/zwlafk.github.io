...
</\></((?:[a-za-z])[\w:-]*)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^></"),e(a),g.foreach(k,function(c,f){var></=b&&a.lastindexof("--\x3e",b)===b&&(d.comment&&d.comment(a.substring(4,></\\s*\\></a.length;c++)d[a[c]]=!0;return>